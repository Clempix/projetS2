...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 203.0, 292.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"data" : 					{
						"clips" : [ 							{
								"filename" : "MUSICAL_INSTRUMENT_GUITARE_HARMONIQUES.wav",
								"filekind" : "audiofile",
								"loop" : 1,
								"content_state" : 								{
									"formant" : [ 1.0 ],
...
,
					...
					"patching_rect" : [ 110.0, 116.0, 150.0, 30.0 ],
					"style" : ""
				}
